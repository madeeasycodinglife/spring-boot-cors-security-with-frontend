...
public class Test {
    public static void main(String[] args) {
        ...
        String token = Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS256, Base64.getEncoder().encode(secretKey.getBytes())) // encode
                // secret key
...
//               .eyJqdGkiOiIyMDAxMjE0MDcwIiwic3ViIjoicGFiaXRyYSIsImlzcyI6Im1hZGVlYXN5IiwiaWF0IjoxNjc2MDM3Njk5LCJleHAiOjE2NzYwMzc3NTl9.ftauYyxldl-L93nLKhi9KocgaVRU_LVU3IRPDjz3vMo";
